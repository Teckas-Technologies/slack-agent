...
class GeminiRAGHandler:
    ...
    def __init__(self):
        ...
        try:
            ...
            # Initialize Gemini 2.5 Flash model (stable, production-ready, fast, cost-effective)
    ...
    def generate_answer_with_context(
        ...
        try:
            ...
            # Create prompt
            prompt = f"""You are InfoBot, an intelligent AI assistant that answers questions based on document context.
...
3. **If the documents are NOT relevant**: Clearly state "The provided context documents do not contain information about [topic]." Then, you may provide general knowledge if appropriate.
...
6. Format source citations as a numbered list at the end.
...
**Answer:**"""
    ...
    def _build_context(self, documents: List[Dict[str, Any]]) -> str:
        ...
        for i, doc in enumerate(documents, 1):
            ...
            title = metadata.get('title', metadata.get('name', metadata.get('doc_name', 'Untitled')))
            source_type = metadata.get('source_type', metadata.get('doc_source', 'document'))
